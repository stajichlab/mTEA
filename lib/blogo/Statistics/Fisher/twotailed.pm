...
package Statistics::Fisher::twotailed;


use Statistics::Fisher::Fisher;
use strict;
use Carp;
use warnings;
...
sub calculateStatistic
{
  ...
  if( !(Statistics::Fisher::Fisher::getValues(\%values)) )
  {
    return;
  }
  ...
  if( !($probabilities = Statistics::Fisher::Fisher::computeDistribution($n11_start, $final_limit)))
  {
      return;
  }
